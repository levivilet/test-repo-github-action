...
;// CONCATENATED MODULE: ./src/parts/CreateBranch/CreateBranch.js



const createBranch = async ({ repositoryPath, version }) => {
...
;// CONCATENATED MODULE: ./src/parts/CreateCommit/CreateCommit.js



const createCommit = async ({ repositoryPath, version }) => {
  const commitMessage = getCommitMessage(version)
  await execa('git', ['commit', '-m', commitMessage], {
    cwd: repositoryPath,
  })
}

;// CONCATENATED MODULE: ./src/parts/CreatePullRequest/CreatePullRequest.js


const createPullRequest = async ({ repositoryPath }) => {
  await execa('gh', ['pr', 'create', '--base', 'main', '--fill'], {
    cwd: repositoryPath,
  })
}

;// CONCATENATED MODULE: ./src/parts/DownloadRepository/DownloadRepository.js
...
;// CONCATENATED MODULE: ./src/parts/JsonFile/JsonFile.js


const readJson = async (path) => {
  const content = await (0,external_fs_promises_namespaceObject.readFile)(path, 'utf8')
  return JSON.parse(content)
}

const writeJson = async (path, value) => {
  await (0,external_fs_promises_namespaceObject.writeFile)(path, JSON.stringify(value, null, 2) + '\n')
}

;// CONCATENATED MODULE: ./src/parts/UpdateRepository/UpdateRepository.js
